...
using purrTTY.TestGameMod.Display;
using StarMap.API;

namespace TestPurrTTY.GameMod;
...
public class TerminalMod
{
    ...
    {
        // Console.WriteLine("TestPurrTTY OnAfterUi");
        ...
        {
            Console.WriteLine($"TestPurrTTY GameMod OnAfterUi error: {ex.Message}");
    ...
    {
        // Console.WriteLine("TestPurrTTY OnBeforeUi");
    ...
    {
        Console.WriteLine("TestPurrTTY OnFullyLoaded");
        try
        {
            InitializeTerminal();
        }
        ...
        {
            Console.WriteLine($"TestPurrTTY GameMod initialization failed: {ex.Message}");
        }
    }
    ...
    {
        Console.WriteLine("TestPurrTTY OnImmediatLoad");
    ...
    public void Unload()
    {
        Console.WriteLine("TestPurrTTY Unload");
        try
        {
            DisposeResources();
        }
        ...
        {
            Console.WriteLine($"TestPurrTTY GameMod unload error: {ex.Message}");
        }
    }
    ...
    private void InitializeTerminal()
    {
        ...
        Console.WriteLine("TestPurrTTY GameMod: Initializing terminal...");
        ...
        try
        {
            ...
            _isInitialized = true;
            Console.WriteLine("TestPurrTTY GameMod: Terminal initialized successfully. Press F12 to toggle.");
        }
        catch (Exception ex)
        {
            Console.WriteLine($"TestPurrTTY GameMod: Terminal initialization failed: {ex.Message}");
            DisposeResources();
            throw;
        }
    }
            ...
            if (!string.IsNullOrEmpty(dllDir))
            {
                ...
                if (Directory.Exists(fontsDir))
                {
                    ...
                    if (fontFiles.Length > 0)
                    {
                        ...
                        Console.WriteLine(
                            $"TestPurrTTY GameMod: Loaded {_loadedFonts.Count} fonts - {string.Join(", ", _loadedFonts.Keys)}");
                    }
                    else
                    {
    ...
    private void DisposeResources()
    {
        ...
        Console.WriteLine("TestPurrTTY GameMod: Disposing resources...");
    }
}
