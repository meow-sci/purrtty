...
namespace purrTTY.Core.Terminal.EmulatorOps;

/// <summary>
///     Handles delete lines operations for the terminal emulator.
///     Extracted from TerminalEmulator to reduce file size and improve maintainability.
/// </summary>
internal class TerminalDeleteLinesOps
{
    ...
    /// <summary>
    ///     Creates a new delete lines operations handler.
    /// </summary>
    ...
    public void DeleteLinesInRegion(int count)
    {
        ...
        _screenBufferManager.DeleteLinesInRegion(count, _cursorManager.Row, _getState().ScrollTop, _getState().ScrollBottom, _attributeManager.CurrentAttributes, _attributeManager.CurrentCharacterProtection);
