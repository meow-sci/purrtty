...
namespace purrTTY.Display.Tests.Unit.Rendering;

/// <summary>
/// Unit tests for PurrTTYFontManager font configuration generation and font family detection.
/// Tests specific examples and edge cases for font configuration functionality.
/// </summary>
[TestFixture]
[Category("Unit")]
public class PurrTTYFontManagerTests
{
    [SetUp]
    public void SetUp()
    {
    ...
    public void CreateFontConfigForFamily_WithFontHavingAll4Variants_ShouldUseAppropriateVariants()
    {
        ...
        // Act
        var config = PurrTTYFontManager.CreateFontConfigForFamily(displayName, fontSize);
    ...
    public void CreateFontConfigForFamily_WithDefaultFontSize_ShouldUse32Point()
    {
        ...
        // Act
        var config = PurrTTYFontManager.CreateFontConfigForFamily(displayName);
    ...
    public void CreateFontConfigForFamily_WithCustomFontSize_ShouldUseSpecifiedSize()
    {
        ...
        // Act
        var config = PurrTTYFontManager.CreateFontConfigForFamily(displayName, customSize);
    ...
    {
        // Act
        var config = PurrTTYFontManager.CreateFontConfigForFamily(invalidName, 20.0f);
    ...
    {
        // Act
        var config = PurrTTYFontManager.CreateFontConfigForFamily(null!, 20.0f);
    ...
    public void GetCurrentFontFamily_WithValidConfigForRegisteredFont_ShouldReturnDisplayName()
    {
        ...
        // Act
        var detectedFamily = PurrTTYFontManager.GetCurrentFontFamily(config);
    ...
    {
        // Act
        var detectedFamily = PurrTTYFontManager.GetCurrentFontFamily(null!);
    ...
    public void CreateFontConfigForFamily_ThenGetCurrentFontFamily_ShouldRoundTrip()
    {
        ...
        // Act
        var config = PurrTTYFontManager.CreateFontConfigForFamily(originalDisplayName, fontSize);
        var detectedFamily = PurrTTYFontManager.GetCurrentFontFamily(config);
    ...
    {
        // Arrange
        var availableFamilies = PurrTTYFontManager.GetAvailableFontFamilies();

        // Act & Assert
        foreach (var family in availableFamilies)
        {
            var config = PurrTTYFontManager.CreateFontConfigForFamily(family, 20.0f);
            var detectedFamily = PurrTTYFontManager.GetCurrentFontFamily(config);
    ...
    {
        // Act
        var definition = PurrTTYFontManager.GetFontFamilyDefinition("Jet Brains Mono");
    ...
    {
        // Act
        var definition = PurrTTYFontManager.GetFontFamilyDefinition("NonExistentFont");
    ...
    public void CreateFontConfigForFamily_WithExtremelySmallFontSize_ShouldWork()
    {
        ...
        // Act
        var config = PurrTTYFontManager.CreateFontConfigForFamily(displayName, tinySize);
    ...
    public void CreateFontConfigForFamily_WithExtremelyLargeFontSize_ShouldWork()
    {
        ...
        // Act
        var config = PurrTTYFontManager.CreateFontConfigForFamily(displayName, largeSize);
