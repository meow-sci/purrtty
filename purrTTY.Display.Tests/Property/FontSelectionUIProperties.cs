    ...
    public FsCheck.Property FontSelectionUIStateConsistency_ShouldMaintainConsistentState()
    {
        return Prop.ForAll(ValidFontFamilyNames(), ValidFontSizes(), (selectedFontFamily, fontSize) =>
        {
            try
            {
                ...
                var newFontConfig = PurrTTYFontManager.CreateFontConfigForFamily(selectedFontFamily, fontSize);
                ...
                var detectedFamily = PurrTTYFontManager.GetCurrentFontFamily(newFontConfig);
                ...
                var definition = PurrTTYFontManager.GetFontFamilyDefinition(selectedFontFamily);
                if (definition == null)
                {
                ...
                var roundTripConfig = PurrTTYFontManager.CreateFontConfigForFamily(selectedFontFamily, fontSize);
    ...
    public FsCheck.Property FontSelectionStatePersistence_ShouldMaintainLastSelection()
    {
                          ...
                          ValidFontSizes(), (fontSelectionSequence, fontSize) =>
        {
            try
            {
                ...
                {
                    var finalDetectedFamily = PurrTTYFontManager.GetCurrentFontFamily(lastConfig);
        ...
        return Prop.ForAll(ValidFontSizes(), fontSize =>
        {
            try
            {
                ...
                foreach (var fontFamily in availableFamilies)
                {
                    ...
                    var definition = PurrTTYFontManager.GetFontFamilyDefinition(fontFamily);
