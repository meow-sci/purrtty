...
- Marker: IMGUI_DEMO_MARKER("Layout/Scrolling/Horizontal (more)")
- Source: .github/skills/imgui/demo.cpp:4269
- Summary: Demonstrates Horizontal (more) behavior within Layout / Scrolling.
