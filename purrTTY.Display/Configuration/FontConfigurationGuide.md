...
This guide explains the different font configuration options available in the purrTTY terminal emulator and when to use each approach.

## Configuration Options

The purrTTY terminal emulator supports three different font configuration approaches:
