...
public static class DpiContextDetector
{
    ...
    public static ExecutionContext DetectExecutionContext()
    {
        try
        {
            ...
            {
                string name = assembly.FullName ?? string.Empty;
                return name.Contains("purrTTY.TestApp", StringComparison.OrdinalIgnoreCase) ||
                       name.Contains("purrTTY.ImGui.Playground", StringComparison.OrdinalIgnoreCase);
            });
            ...
            if (entryAssembly != null)
            {
                ...
                if (entryName.Contains("purrTTY.TestApp", StringComparison.OrdinalIgnoreCase) ||
                    entryName.Contains("purrTTY.ImGui.Playground", StringComparison.OrdinalIgnoreCase))
                {
    ...
    public static string GetDiagnosticInfo()
    {
        try
        {
            ...
            info.AppendLine("\npurrTTY-related Assemblies:");
            var purrTTYAssemblies = assemblies.Where(a =>
                a.FullName?.Contains("purrTTY", StringComparison.OrdinalIgnoreCase) == true).ToList();

            foreach (Assembly assembly in purrTTYAssemblies)
            {
                info.AppendLine($"  - {assembly.GetName().Name}");
            }
