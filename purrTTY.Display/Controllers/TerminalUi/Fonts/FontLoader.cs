...
/// <summary>
///     Handles font loading from various sources (FontManager, PurrTTYFontManager, GameMod reflection).
/// </summary>
internal class FontLoader
{
  ...
  private ImFontPtr? FindFont(string fontName)
  {
    ...
    try
    {
      ...
      var gameModType = Type.GetType("purrTTY.GameMod.TerminalMod, purrTTY");
      if (gameModType != null)
      {
  ...
  public void PushUIFont(out bool fontUsed)
  {
    try
    {
      ...
      if (PurrTTYFontManager.LoadedFonts.TryGetValue("HackNerdFontMono-Regular", out ImFontPtr hackFont))
      {
