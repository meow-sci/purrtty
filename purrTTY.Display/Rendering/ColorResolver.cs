...
public class ColorResolver
{
    ...
    public float4 Resolve(purrTTY.Core.Types.Color? color, bool isBackground = false)
    {
...
//            _perfWatch.Stop("ColorResolver.ResolveIndexedColor.Grayscale");
    ...
    public static purrTTY.Core.Types.Color? AnsiCodeToColor(int colorCode)
    {
        ...
        if (colorCode >= 30 && colorCode <= 37)
        {
            ...
            return new purrTTY.Core.Types.Color(namedColors[colorCode - 30]);
        }
        ...
        if (colorCode >= 90 && colorCode <= 97)
        {
            ...
            return new purrTTY.Core.Types.Color(namedColors[colorCode - 90]);
        }
        ...
        if (colorCode >= 40 && colorCode <= 47)
        {
            ...
            return new purrTTY.Core.Types.Color(namedColors[colorCode - 40]);
        }
        ...
        if (colorCode >= 100 && colorCode <= 107)
        {
            ...
            return new purrTTY.Core.Types.Color(namedColors[colorCode - 100]);
        }
    ...
    public static purrTTY.Core.Types.Color CreateIndexedColor(byte index)
    {
        return new purrTTY.Core.Types.Color(index);
    }
    ...
    public static purrTTY.Core.Types.Color CreateRgbColor(byte r, byte g, byte b)
    {
        return new purrTTY.Core.Types.Color(r, g, b);
    }
    ...
    public static purrTTY.Core.Types.Color CreateNamedColor(NamedColor namedColor)
    {
        return new purrTTY.Core.Types.Color(namedColor);
    }
}