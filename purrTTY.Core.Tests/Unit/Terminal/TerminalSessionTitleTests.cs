...
namespace purrTTY.Core.Tests.Unit.Terminal;
...
public class TerminalSessionTitleTests
{
    ...
    private purrTTY.Core.Tests.Property.MockProcessManager _processManager = null!;
    ...
    public void SetUp()
    {
        ...
        _processManager = new purrTTY.Core.Tests.Property.MockProcessManager();
