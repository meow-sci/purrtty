...
public static class RpcParameterGenerators
{
    ...
    public static Arbitrary<RpcParameters> RpcParameters()
    {
        return Gen.Sized(size =>
            ...
            select new purrTTY.Core.Rpc.RpcParameters
            {
    ...
    public static Arbitrary<ValidatedRpcCommand> ValidatedRpcCommand()
    {
        return Gen.OneOf(
            ...
            Gen.Constant(new ValidatedRpcCommand
            {
                ...
                ValidParameters = new purrTTY.Core.Rpc.RpcParameters
                {
                    NumericParameters = new[] { 50 }
                },
                InvalidParameters = new purrTTY.Core.Rpc.RpcParameters
                {
    ...
    public static Arbitrary<SecuritySensitiveCommand> SecuritySensitiveCommand()
    {
        return Gen.OneOf(
            ...
            Gen.Constant(new SecuritySensitiveCommand
            {
                ...
                ViolatingParameters = new purrTTY.Core.Rpc.RpcParameters
                {
                    NumericParameters = new[] { 150 }
                }
            }),
...
public class UnsafeRpcParameters
{
    ...
    public purrTTY.Core.Rpc.RpcParameters ToRpcParameters()
    {
        return new purrTTY.Core.Rpc.RpcParameters
        {
...
public class ValidatedRpcCommand
{
    ...
    public purrTTY.Core.Rpc.RpcParameters ValidParameters { get; set; } = new();
    public purrTTY.Core.Rpc.RpcParameters InvalidParameters { get; set; } = new();
}
...
{
    public RpcParameterValidationRules Rules { get; set; } = new();
    public purrTTY.Core.Rpc.RpcParameters ViolatingParameters { get; set; } = new();
}
