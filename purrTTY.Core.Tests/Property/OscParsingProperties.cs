...
public class OscParsingProperties
{
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 23: OSC parsing and event emission**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 23b: OSC title sequence event emission**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 23c: OSC clipboard sequence event emission**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 23d: OSC clipboard query event emission**
    ///     **Validates: Requirements 13.4**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 23e: OSC clipboard clear event emission**
    ///     **Validates: Requirements 13.4**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 23f: OSC parsing robustness**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 23g: OSC payload length limits**
    ///     **Validates: Requirements 13.1**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 24: OSC hyperlink association**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 24b: OSC hyperlink state management**
    ///     **Validates: Requirements 13.3**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 24c: OSC hyperlink parameter handling**
    ///     **Validates: Requirements 13.3**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 25: Unknown OSC sequence handling**
