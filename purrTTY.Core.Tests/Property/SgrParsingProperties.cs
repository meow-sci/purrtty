...
public class SgrParsingProperties
{
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 21: SGR parsing and application**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 21b: SGR parameter parsing consistency**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 21c: SGR attribute application idempotency**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 21d: SGR color parsing correctness**
    ///     **Validates: Requirements 12.1, 12.4**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 21e: SGR attribute application preserves unrelated attributes**
    ///     **Validates: Requirements 12.2, 12.5**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 21f: SGR indexed color parsing correctness**
    ///     **Validates: Requirements 12.1, 12.4**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 21g: SGR underline style parsing correctness**
    ...
    /// <summary>
    ///     **Feature: purrTTY-ksa, Property 22: SGR reset behavior**
