namespace purrTTY.TestApp;

/// <summary>
///     Standalone BRUTAL ImGui test application for purrTTY terminal emulator.
...
public class Program
{
    ...
    {
        Console.WriteLine("purrTTY BRUTAL ImGui Test Application");
        Console.WriteLine("===================================");
        Console.WriteLine();
        ...
        catch (Exception ex)
        {
            ...
            Console.WriteLine("The application must be run from the project directory (purrTTY.TestApp/).");
            Environment.Exit(1);
        }
    }
}
