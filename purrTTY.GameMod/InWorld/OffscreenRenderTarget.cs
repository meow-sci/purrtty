...
///     <para>
///         Phase 2: the asset exists in GPU memory but nothing renders into it yet.
///         The render pass is built via <see cref="RenderTarget.CreateRenderPass"/>,
///         which finalizes the color attachment to <c>ShaderReadOnlyOptimal</c>; no
///         manual post-render layout transition is required.
///     </para>
/// </summary>
