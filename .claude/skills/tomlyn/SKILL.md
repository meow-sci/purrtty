...
| Scenario | Start here |
| --- | --- |
| New to Tomlyn | [Getting started](./docs/getting-started.md) |
| Familiar with [`System.Text.Json`](xref:System.Text.Json) | [Serialization](./docs/serialization.md) - the API shape is intentionally similar |
| Need NativeAOT / trimming | [Source generation](./docs/source-generation.md) |
| Want a dynamic model (no POCOs) | [DOM model](./docs/dom.md) - [`TomlTable`](xref:Tomlyn.Model.TomlTable), [`TomlArray`](xref:Tomlyn.Model.TomlArray) |
| Building tooling (formatters, analyzers) | [Low-level APIs](./docs/low-level.md) - [`SyntaxParser`](xref:Tomlyn.Parsing.SyntaxParser) |
| Migrating from Tomlyn v0.x | [Migration guide](./docs/migration.md) |
